...
public class ManageCustomersFormController {
    ...
    private void loadAllCustomers() {
        ...
        try {
          ...
          /*  Connection connection = DBConnection.getDbConnection().getConnection();
            ...
            List<CustomerDTO> allCustomer = new CustomersDAOimpl().getAllCustomer();
    ...
    public void btnSave_OnAction(ActionEvent actionEvent) {
        ...
        if (btnSave.getText().equalsIgnoreCase("save")) {
            ...
            boolean isSaved = customerDAO.saveAllCustomer(new CustomerDTO( id , name , address));
    ...
    private String generateNewId() {
        try {
         ...
         //   CustomerDAO customerDAO = new CustomersDAOimpl();
            String custId = customerDAO.generateNewCustomerId();
