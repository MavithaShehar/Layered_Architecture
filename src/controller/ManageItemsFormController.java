...
public class ManageItemsFormController {
    ...
    private void loadAllItems() {
        ...
        try {
           ...
           // ItemsDAO itemsDAO = new ItemsDAOimpl();
            List<ItemDTO> allItem = itemsDAO.getAllItems();
    ...
    public void btnDelete_OnAction(ActionEvent actionEvent) {
        ...
        try {
           ...
           // ItemsDAO itemsDAO = new ItemsDAOimpl();
            boolean isDelete = itemsDAO.ItemDelete(code);
    ...
    public void btnSave_OnAction(ActionEvent actionEvent) {
        ...
        if (btnSave.getText().equalsIgnoreCase("save")) {
            try {
             ...
             //   ItemsDAO itemsDAO = new ItemsDAOimpl();
                boolean isSave = itemsDAO.saveItems(new ItemDTO(code,description,unitPrice,qtyOnHand));
            ...
            try {
             ...
             //   ItemsDAO itemsDAO = new ItemsDAOimpl();
                boolean isUpdate = itemsDAO.updateItem(new ItemDTO(code,description,unitPrice,qtyOnHand));
    ...
    private String generateNewId() {
        try {
           ...
           /* Connection connection = DBConnection.getDbConnection().getConnection();
            ...
            //ItemsDAO itemsDAO = new ItemsDAOimpl();
            String newId = itemsDAO.genereateNewItemId();
